...
document.getElementById('buyVipWorker')?.addEventListener('click', ()=>sendPremiumRequest('vip_worker_100'));
document.getElementById('buyVip150')?.addEventListener('click', ()=>sendPremiumRequest('vip_150'));
document.getElementById('buyPremium200')?.addEventListener('click', ()=>sendPremiumRequest('premium_200'));
