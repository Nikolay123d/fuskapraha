...
document.getElementById('drawerUserBots')?.addEventListener('click', (e)=>{ e.preventDefault(); openPrivModal('bots'); try{ window.__closeDrawer?.(); }catch{} });
  document.getElementById('drawerPremium')?.addEventListener('click', (e)=>{ e.preventDefault(); openPremiumBotDM(''); try{ if(typeof closeDrawer==='function') closeDrawer(); }catch(_e){} });
