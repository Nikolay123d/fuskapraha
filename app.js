...
window.ADMIN_EMAILS = ["urciknikolaj642@gmail.com","urciknikolaj62@gmail.com"];
...
// --- DM threads / inbox ---
  ...
  async function loadDmThreads(){
    ...
    for(const room of rooms){
      ...
      row.className='msg';
      row.innerHTML = `
        <div class="ava" data-uid="${r.uid}"><img src="${esc(u.avatar||window.DEFAULT_AVATAR)}" alt=""></div>
        <div class="bubble" style="width:100%;cursor:pointer">
          <div class="name" data-uid="${r.uid}"><b>${esc(u.nick||'Uživatel')}</b> <span class="muted">${u.online?'online':'offline'}</span></div>
