...
window.ADMIN_UID = "rN93vIzh0AUhX1YsSWb6Th6W9w82";
...
function isAdminUser(u){ return !!(u && u.uid === window.ADMIN_UID); }
...
async function loadChat(){
  ...
  const cb=async (snap)=>{
    ...
    const isAdm = (m.by === window.ADMIN_UID);
...
// === FRIENDS ===
async async function friendItem(uid, st){
