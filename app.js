...
document.getElementById('adminBroadcastClose')?.addEventListener('click', ()=>closeModal('adminBroadcastModal'));
  ...
  document.getElementById('adminDesignBtn')?.addEventListener('click', ()=>{ try{ showView('view-profile'); }catch(e){} });
  document.getElementById('adminSoundsBtn')?.addEventListener('click', ()=>{ try{ showView('view-profile'); }catch(e){} });
