...
(function(){
  ...
  document.getElementById('authForgotBtn')?.addEventListener('click', ()=>{ try{ doPasswordReset(); }catch(e){ try{ toast(e.message||'Chyba'); }catch(_){ alert(e.message||'Chyba'); } } });
  document.getElementById('authResetPass')?.addEventListener('click', ()=>{ try{ doPasswordReset(); }catch(e){ try{ toast(e.message||'Chyba'); }catch(_){ alert(e.message||'Chyba'); } } });
