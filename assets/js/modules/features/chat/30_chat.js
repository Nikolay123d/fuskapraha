...
function ensureGuestUiState(){
  ...
  send.disabled  = isGuest;
  att.disabled   = isGuest;
  input.placeholder = isGuest ? 'Гостевой режим: читать можно, писать — после входа' : 'Сообщение…';
}
