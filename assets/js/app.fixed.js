...
document.addEventListener('DOMContentLoaded',function(){
 firebase.auth().onAuthStateChanged(function(u){if(!u){showView('view-auth');return}openByTab(getTab())});
 var b=document.getElementById('login-google');
 if(b)b.onclick=function(){firebase.auth().signInWithPopup(new firebase.auth.GoogleAuthProvider())}
});
