...
function showView(id, opts){
  ...
  // Product analytics: feature opens (best-effort, never block UI)
  try{
    const map={
      'view-chat':'open_chat',
      'view-dm':'open_dm',
      'view-profile':'open_profile',
      'view-friends':'open_friends',
      'view-members':'open_members',
      'view-rent':'open_rent',
      'view-premium':'open_premium',
      'view-autopost':'open_autopost',
      'view-admin':'open_admin'
    };
    const ev = map[id];
    if(ev && window.MK_usage) MK_usage(ev, 1);
  }catch(e){}
