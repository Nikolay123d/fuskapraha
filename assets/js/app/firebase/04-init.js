...
let functions = null;
try{ functions = firebase.app().functions('europe-west1'); }catch(e){
  try{ functions = firebase.functions(); }catch(_){ functions = null; }
}
try{ window.functions = functions; }catch(e){}
