...
function isAdminUser(u){
  // Single source of truth: roles/{uid}/admin (cached by auth-state watchers)
  try{ if(window.__myRoles && window.__myRoles.admin===true) return true; }catch(e){}
  // Bootstrap fallback: hardcoded UID allowlist (no email-based admin)
  try{
