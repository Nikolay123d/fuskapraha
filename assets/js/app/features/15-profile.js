...
// Fix: after F5 / initial load the profile view could display placeholder values
// until something (e.g. avatar update) forced a refresh.
try{
  window.loadProfile = ()=>{ try{ refreshMe(); }catch(e){} };
  window.addEventListener('auth:state', ()=>{ try{ refreshMe(); }catch(e){} });
}catch(e){}
