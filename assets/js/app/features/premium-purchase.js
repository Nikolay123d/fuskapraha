...
(function premiumPurchaseModule(){
  ...
  const DEFAULT_PLANS = {
    premium:     { title:'Premium',     price:'150 Kč', period:'30 dní', desc:'Odznak v chatu + vyšší limity.' },
    premiumPlus: { title:'Premium+',    price:'200 Kč', period:'30 dní', desc:'Ještě vyšší limity + status.' },
    vip:         { title:'VIP',         price:'100 Kč', period:'30 dní', desc:'Maximální limity + VIP odznak.' }
  };
