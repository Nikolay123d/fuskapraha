...
(function mkAdminBots(){
      ...
      if(listEl){
        ...
        if(!ids.length){
          ...
          ids.forEach(id=>{
            ...
            ava.className='ava';
            ava.alt='bot';
            ava.src = safeImgSrc(normalizeAvatarUrl(b.avatar||'./img/default-avatar.svg'), 'assets/img/default-avatar.svg');
  ...
  // Admin section buttons (no inline onclick)
  document.addEventListener('DOMContentLoaded', ()=>{
    const btn1 = document.getElementById('adminOpenBots');
    const btn2 = document.getElementById('adminOpenBotInbox');
    if(btn1 && btn1.dataset.wired!=='1'){
