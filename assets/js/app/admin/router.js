...
(function adminRouter(){
  ...
  const sectionIds = {
    ...
    moderation: 'adminSectionModeration',
    autopost: 'adminSectionAutopost',
    bots: 'adminSectionBots',
    settings: 'adminSectionSettings',
    logs: 'adminSectionLogs',
    support: 'adminSectionSupport',
    security: 'adminSectionSecurity'
  };
  ...
  function _stopSection(key){
    try{
      if(key === 'premium'){
        try{ window.stopAdminPremiumLive?.(); }catch(e){}
      }
      if(key === 'settings'){
        try{ window.stopAdminSettingsLive?.(); }catch(e){}
      }
      if(key === 'dashboard'){
        try{ window.stopAdminDashboardLive?.(); }catch(e){}
      }
      if(key === 'autopost'){
        try{ window.stopAdminAutopostLive?.(); }catch(e){}
      }
    }catch(e){}
  }
  ...
  function _startSection(key){
    try{
      if(key === 'dashboard'){
        try{ window.initAdminDashboard?.(); }catch(e){}
      }
      if(key === 'premium'){
        try{ window.stopAdminPremiumLive?.(); }catch(e){}
      }
      ...
      if(key === 'autopost'){
        try{ window.initAdminAutopost?.(); }catch(e){}
      }
      if(key === 'logs'){
