      ...
      for(const it0 of list){
        ...
        el.innerHTML = `
          ...
          <div class="bubble" style="width:100%">
            ...
            ${safeImgSrc(it.img,'')?`<div class="text"><img src="${esc(safeImgSrc(it.img,''))}"></div>`:''}
            <div class="actions">
        ...
        try{
          ...
          if(imgEl && it.fromUid){
            getUser(it.fromUid).then(u=>{ if(u && u.avatar) imgEl.src = safeImgSrc(u.avatar, window.DEFAULT_AVATAR); }).catch(()=>{});
          }
        }catch(e){}
