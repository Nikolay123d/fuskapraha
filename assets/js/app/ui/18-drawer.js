...
(function initMobileNav(){
  ...
  drawer?.addEventListener('click', (e)=>{
    ...
    // Premium shortcut opens the dedicated Premium/VIP modal (no DM dependency)
    if(a.id==='drawerPremium'){
      try{ if(window.openPremium) openPremium(); else openPremiumBot(); }catch{}
    }
    closeDrawer();
  });
