...
exports.translateCityChat = onValueCreated("/messages/{city}/{msgId}", async (event) => translateNode(`messages/${event.params.city}/${event.params.msgId}`));
exports.translateRent = onValueCreated("/rentMessages/{city}/{msgId}", async (event) => translateNode(`rentMessages/${event.params.city}/${event.params.msgId}`));
exports.translateDm = onValueCreated("/dm/{dialogId}/items/{msgId}", async (event) => translateNode(`dm/${event.params.dialogId}/items/${event.params.msgId}`));
